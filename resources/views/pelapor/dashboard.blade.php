    ...
    <div class="modal w-sm">
        ...
        <div class="modal-body" style="padding: 24px;">
            ...
            <div style="margin-bottom: 16px;">
                ...
                <a href="{{ url('/download-template/' . rawurlencode($t->template_laporan)) }}" download class="btn btn-ghost btn-sm" style="display: inline-flex; align-items: center; gap: 8px; border: 1.5px solid #3b82f6; color: #1d4ed8; background: #eff6ff; padding: 8px 14px; border-radius: 6px; font-weight: 600; text-decoration: none;">
