            ...
            <tbody>
                @forelse($tickets as $t)
                    <tr style="border-bottom: 1px solid var(--line);">
                        ...
                        <td style="padding: 1rem 1.5rem;">
                            <div style="display: inline-flex; align-items: center; gap: 6px; background: #eff6ff; color: #1d4ed8; padding: 4px 10px; border-radius: 6px; font-weight: 600; font-size: 0.85rem; border: 1px solid #bfdbfe; cursor: default;">
