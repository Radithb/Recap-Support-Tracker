        ...
        <div class="login-split-layout fade-up" style="animation-delay: 0.1s;">
            ...
            <div class="login-split-left">
                ...
                <div class="badges-bg">
                    ...
                    <div class="badge-float" style="top: 33%; right: 26%; --scale: 0.9; opacity: 0.8; animation: float-badge 7s ease-in-out infinite 1s;">SAKTI.Link</div>
                    ...
                    <div class="badge-float" style="top: 57%; right: 28%; --scale: 0.88; opacity: 0.75; animation: float-badge 6.5s ease-in-out infinite 1.5s;">SAKTI Mobile</div>
                    ...
                    <div class="badge-float" style="top: 79%; right: 22%; --scale: 0.8; opacity: 0.65; animation: float-badge 6s ease-in-out infinite 2s;">SAKTI Retail</div>
